...
* **What is the project structure of an Android Application?**
 ...
 >    - **AndroidManifest.xml**: contains app configurations such as permissions, components, ...
 >    - **java**: contains Java/Kotlin code
 >    - **jni**: contains Java Native Interface code
 >    - **gen**: contains Java code generated by Android Studion automatically (e.g. View binding classes).
 >    - **src**: contains app recources such as drawables, strings, styles, layouts, ...
 >    - **assets**: contains app resources which have to include in the Android packages as-is (without any changes).
